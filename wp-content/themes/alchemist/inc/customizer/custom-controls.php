 ...
 */
function alchemist_custom_controls( $wp_customize ) {
	// Custom control for Important Links.
	class Alchemist_Important_Links_Control extends WP_Customize_Control {
		...
		public function render_content() {
			...
			$important_links = array(
				'theme_instructions' => array(
					'link'  => esc_url( 'https://catchthemes.com/themes/alchemist/#theme-instructions' ),
					'text'  => esc_html__( 'Theme Instructions', 'alchemist' ),
					),
				'support' => array(
					'link'  => esc_url( 'https://catchthemes.com/support/' ),
					'text'  => esc_html__( 'Support', 'alchemist' ),
					),
				'changelog' => array(
					'link'  => esc_url( 'https://catchthemes.com/themes/alchemist/#changelog' ),
					'text'  => esc_html__( 'Changelog', 'alchemist' ),
					),
				'facebook' => array(
					'link'  => esc_url( 'https://www.facebook.com/catchthemes/' ),
					'text'  => esc_html__( 'Facebook', 'alchemist' ),
					),
				'twitter' => array(
					'link'  => esc_url( 'https://twitter.com/catchthemes/' ),
					'text'  => esc_html__( 'Twitter', 'alchemist' ),
					),
				'gplus' => array(
					'link'  => esc_url( 'https://plus.google.com/+Catchthemes/' ),
					'text'  => esc_html__( 'Google+', 'alchemist' ),
					),
				'pinterest' => array(
					'link'  => esc_url( 'http://www.pinterest.com/catchthemes/' ),
					'text'  => esc_html__( 'Pinterest', 'alchemist' ),
					),
			);
	...
	class Alchemist_Multi_Cat extends WP_Customize_Control {
		...
		public function render_content() {
			$dropdown = wp_dropdown_categories(
				array(
					...
					'hide_if_empty'    => false,
					'show_option_all'  => esc_html__( 'All Categories', 'alchemist' ),
				)
			);
			...
			echo '<p class="description">' . esc_html__( 'Hold down the Ctrl (windows) / Command (Mac) button to select multiple options.', 'alchemist' ) . '</p>';
		}
	}

	// Custom control for any note, use label as output description.
	class Alchemist_Note_Control extends WP_Customize_Control {
	...
	class Alchemist_Toggle_Control extends WP_Customize_Control {
		public $type = 'light';
...
add_action( 'customize_register', 'alchemist_custom_controls', 1 );
