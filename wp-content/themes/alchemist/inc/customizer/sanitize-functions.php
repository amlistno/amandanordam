<?php
/**
 * Alchemist Theme Options Sanitization Functions
 *
 * @package Alchemist
 */
 ...
 */
function alchemist_sanitize_select( $input, $setting ) {
 ...
 */
function alchemist_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function alchemist_sanitize_post( $input ) {
 ...
 * @since Alchemist 1.0
 */
function alchemist_sanitize_category_list( $input ) {
 ...
 *                    the setting default.
 */
function alchemist_sanitize_number_range( $number, $setting ) {
